...
parser.add_argument('-D', '--dataset', type=str, default='ecoli', choices=['ecoli','labmix','complex32','medium20','helicobacter-hepaticus'], help='Dataset: ecoli (default), labmix (fixed), complex32 (abundances from complex32/nanosim.abundances.tsv), medium20 (parsed like complex32), helicobacter-hepaticus (compressed FASTA .gz)')
